...
public class MissionManagerImplTests {
    ...
    public void createMission() {
        ...
        Mission mission = newMission("m1", 2, 3, true);
    ...
    public void findMission() {
        ...
        Mission mission = newMission("m2", 5, 4, false);
        manager.createMission(mission);
        Long missionId = mission.getId();
    ...
    public void findAllMissions() {
        ...
        Mission m1 = newMission("m2",5, 4, true);
        Mission m2 = newMission("m3",4, 2, false);
    ...
    public void addMissionWithNegativeCapacity() {
        Mission mission = newMission("m2", 2, -1, true);
    ...
    public void addMissionWithZeroCapacity() {
        Mission mission = newMission("m2",2, 0, true);
        manager.createMission(mission);
    }

    @Test(expected = IllegalEntityException.class)
    public void updateMissionSetIdNegative() {
        Mission mission = newMission("m2",2, 4, true);
        manager.createMission(mission);
    ...
    public void updateMission()  {
        Mission m1 = newMission("m2",5, 4, true);
        Mission m2 = newMission("m2",4, 3, false);
        manager.createMission(m1);
        manager.createMission(m2);
